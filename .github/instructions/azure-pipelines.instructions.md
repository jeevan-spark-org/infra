...
- Reuse stage and step templates from `infra-pipeline-common`.
...
- Keep environment names lowercase and load environment variable files from `infra-pipeline-common` using lowercase conventions (for example `pipelines/variables/dev.yml`, `pipelines/variables/prd.yml`).
